/* *************************************************************************************************************
NOMBRE DEL PROGRAMA: [PR_SEG_ConsultarMenuRequiereDualPorRol]
DESCRIPCION: Consulta los menus que requieren control dual por Rol
...
DESCRIPCIÓN: Consulta los menus que requieren control dual por Rol
AUTOR: Paulo Andrés Mora.
EMPRESA: UT - BAC
FECHA DE CREACIÓN: 2016-06-16
***************************************************************************************************************/
CREATE PROCEDURE [dbo].[PR_SEG_ConsultarMenuRequiereDualPorRol]
@idRol int
AS
BEGIN
    SELECT DISTINCT	
	...
	FROM	SEG_Menu M INNER JOIN
			...
			ON ACD.id_Menu = M.idMenu AND ACD.Requiere = 1 INNER JOIN
			SEG_Permisos P 
